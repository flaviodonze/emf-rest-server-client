...
import com.softmodeler.common.communication.ser.SoftmodelerEcoreReferenceDeserializer;
import com.softmodeler.common.communication.ser.SoftmodelerEcoreReferenceSerializer;
...
public class ExtendedEMFProvider extends JacksonJaxbJsonProvider {
	...
	private JsonResourceFactory setupFactory() {
		...
		module.setReferenceSerializer(new SoftmodelerEcoreReferenceSerializer());
		module.setReferenceDeserializer(new SoftmodelerEcoreReferenceDeserializer());
